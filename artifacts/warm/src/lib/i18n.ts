...
const T: Record<Lang, Translations> = {
  ...
  es: {
    ...
    safetyBody:
      'Si el nivel de batería desciende al 20% la sesión se interrumpirá de forma automática para cuidar la energía de su batería. Asegúrese de contar con carga suficiente antes de iniciar la terapia térmica.',
    autoStop: {
